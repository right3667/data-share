...
### 2-2. WebDriverAgent 적용
  ...
  - 'Enter repository URL' 에 복제할 WDA 프로젝트 URL 을 입력 후 'Clone' 클릭한다.<br>https://github.com/appium/WebDriverAgent.git<br>
...
### 2-3. Xcode 개발자 계정 등록
  ...
  - Clone 했던 WDA 프로젝트 'TARGETS' 항목들의 [Signing & Capabilities > all > Team] 을 로그인한 애플 개발자 계정으로 등록하고,<br>
    Bundle Identifier 가 'com.facebook.WebDriverAgentLib' 로 적용됨을 확인한다.<br>
    <image src="doc/iOS_connect/Targets_dev_identifier.png" style="width: 800px;"><br><br><br>
## 3. WDA 빌드 및 인증서 등록
  - Xcode 상단에서 'WebDriverAgentRunner' 및 Mac PC와 연결된 테스트 기기를 선택한 뒤 빌드한다.<br>
